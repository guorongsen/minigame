import { CharacterMutationFusionConfig, CharacterMutationGeneConfig } from "../types";

export const characterMutationGenes: CharacterMutationGeneConfig[] = [
  {
    id: "gene_fury",
    name: "狂怒基因",
    color: "#ff8a7a",
...
export const characterMutationFusions: CharacterMutationFusionConfig[] = [
  {
